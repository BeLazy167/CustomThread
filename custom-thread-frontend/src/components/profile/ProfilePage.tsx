...
export default function ProfilePage() {
    ...
    const [_userData, setUserData] = useState(initialUserData);
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span>
                                            Specialties:{" "}
                                            {initialUserData.specialties
                                                ? initialUserData.specialties.join(
                                                      ", "
                                                  )
                                                : "Not specified"}
                                        </span>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    Based on $10 commission per sale
                                </p>
                            </CardContent>
                        </Card>
